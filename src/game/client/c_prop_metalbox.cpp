...
class C_Prop_Metalbox : public C_PhysicsProp
{
public:
	DECLARE_CLASS( C_Prop_Metalbox, C_PhysicsProp );
	DECLARE_CLIENTCLASS();
...
CMaterialReference C_Prop_Metalbox::sm_OcclusionProxyMaterial;

IMPLEMENT_CLIENTCLASS_DT( C_Prop_Metalbox, DT_Prop_Metalbox, CProp_Metalbox )
...
void C_Prop_Metalbox::Spawn( void )
{
...
void C_Prop_Metalbox::UpdateOnRemove( void )
{
	BaseClass::UpdateOnRemove();
}

void C_Prop_Metalbox::OnDataChanged( DataUpdateType_t type )
{
	if( !m_bEnabled )
	{
...
int C_Prop_Metalbox::DrawModel( int flags, const RenderableInstance_t &instance )
{
...
ShadowType_t C_Prop_Metalbox::ShadowCastType( void )
{
	return SHADOWS_NONE;
}
